...
export class AgentConfig {
  ...
  loadFromEnv() {
    ...
    this.agent = {
      ...
      planSolve: {
        maxPlanSteps: parseInt(process.env.MAX_PLAN_STEPS) || 8,
        enablePlanRefinement: process.env.ENABLE_PLAN_REFINEMENT !== 'false',
        detailedReasoning: process.env.DETAILED_REASONING !== 'false'
      }
    };
